...
{{--                <p>--}}
{{--                    <strong>Email:</strong>--}}
{{--                    <a href="mailto:Aimanakbota0@gmail.com" style="color: white; text-decoration: none;">--}}
{{--                        Aimanakbota0@gmail.com--}}
{{--                    </a>--}}
{{--                </p>--}}
{{--                <p>--}}
{{--                    <strong>Телефон:</strong>--}}
{{--                    <a href="tel:+77770295229" style="color: white; text-decoration: none;">--}}
{{--                        +7 777 029 52 29--}}
{{--                    </a>--}}
{{--                </p>--}}
{{--            </div>--}}
...
<!-- Блок с баннером -->
<div style="background-color: #ddd; padding: 20px; text-align: center;">
    <h2>Добро пожаловать в TechStore!</h2>
    <p>У нас вы найдете качественную и надежную бытовую технику по доступным ценам. В ассортименте представлены телевизоры, холодильники, стиральные машины, пылесосы, кухонная техника и многое другое.

        Перейдите в раздел "Товары" и выберите технику, которая вам нужна!
        TechStore – лучшее решение для вашего комфорта. 🚀</p>
</div>

<!-- Новости бытовой техники -->
<div class="container">
    <h2 class="text-center">Новости бытовой техники</h2>

    <div class="news-row">
        <div class="news-item">
            <img src="/images/Smart_TV.jpeg" alt="Samsung Smart TV" class="news-image">
            <div class="news-content">
                <h3>Новый Samsung Smart TV 2025</h3>
                <p>Компания Samsung представила новый телевизор с 8K-разрешением.</p>
                <a href="https://www.samsung.com/" target="_blank" class="read-more">Подробнее</a>
            </div>
        </div>

        <div class="news-item">
            <img src="/images/holod.jpeg" alt="LG Refrigerator" class="news-image">
            <div class="news-content">
                <h3>LG выпустила революционный холодильник</h3>
                <p>Холодильник LG теперь с поддержкой AI и голосового управления.</p>
                <a href="https://www.lg.com/" target="_blank" class="read-more">Подробнее</a>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="news-row">
        <div class="news-item">
            <img src="/images/samsung.jpeg" alt="Телевизор Samsung" class="news-image">
            <div class="news-content">
                <h3>Телевизор Samsung 55"</h3>
                <p>Цена: 250 000 тг</p>
                <a href="{{ route('products') }}" class="read-more">Посмотреть</a>
            </div>
        </div>

        <div class="news-item">
            <img src="/images/holodilnikstr.jpeg" alt="Холодильник LG" class="news-image">
            <div class="news-content">
                <h3>Холодильник LG</h3>
                <p>Цена: 1 800 000 тг</p>
                <a href="{{ route('products') }}" class="read-more">Посмотреть</a>
            </div>
        </div>
    </div>
...
<!-- Footer -->
<footer>
    <p>TechStore &copy; 2025. Все права защищены.</p>
    <p>
        <strong>Email:</strong> <a href="mailto:aimanakbota0@gmail.com" style="color: white;">aimanakbota0@gmail.com</a>
    </p>
    <p>
        <strong>Телефон:</strong> <a href="tel:+77001234567" style="color: white;">+7 700 123 45 67</a>
    </p>
</footer>
